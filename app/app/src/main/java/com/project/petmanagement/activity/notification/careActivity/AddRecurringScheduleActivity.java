...
public class AddRecurringScheduleActivity extends AppCompatActivity implements DayOfWeekInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_recurring_schedule);
            ...
            if (noRepeatLayout.getVisibility() == View.VISIBLE) {
                if (validationNoRepeat()) {
                    try {
                        ...
                        Intent intent = new Intent(AddRecurringScheduleActivity.this, AddCareActivityNotificationActivity.class);
        ...
        changeFrequency.setOnClickListener(v -> {
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(AddRecurringScheduleActivity.this);
    ...
    private boolean validationRepeatWeek() {
        if (startDateWeekRepeat.length() == 0) {
            DialogUtils.setUpDialog(AddRecurringScheduleActivity.this, "Ngày bắt đầu không được để trống");
            return false;
        }
        if (endDateWeekRepeat.length() == 0) {
            DialogUtils.setUpDialog(AddRecurringScheduleActivity.this, "Ngày kết thúc không được để trống");
            return false;
        }
        return true;
    }
    ...
    private boolean validationNoRepeat() {
        if (dateNoRepeat.length() == 0) {
            DialogUtils.setUpDialog(AddRecurringScheduleActivity.this, "Ngày không được để trống");
            return false;
        }
        if (hourNoRepeat.length() == 0) {
            DialogUtils.setUpDialog(AddRecurringScheduleActivity.this, "Giờ không được để trống");
            return false;
        }
        return true;
    }
    ...
    private void customDate(TextInputEditText editDate) {
        ...
        editDate.setOnClickListener(v -> {
            datePickerDialog = new DatePickerDialog(AddRecurringScheduleActivity.this, (view, year1, month1, dayOfMonth) -> {
                ...
                try {
                    ...
                    if (cal1.compareTo(cal2) > 0) {
                        DialogUtils.setUpDialog(AddRecurringScheduleActivity.this, "Ngày bạn chọn phải lớn hơn hoặc bằng ngày hiện tại");
                    } else {
    ...
    private void customTimepickerTextView() {
        ...
        chooseHourDayRepeat.setOnClickListener(v -> {
            timePickerDialog = new TimePickerDialog(AddRecurringScheduleActivity.this, (view, hourOfDay, minute1) -> {
            ...
            datePickerDialog = new DatePickerDialog(AddRecurringScheduleActivity.this, (view, year1, month1, dayOfMonth) -> {
                ...
                try {
                    ...
                    if (check) {
                        ...
                        DialogUtils.setUpDialog(AddRecurringScheduleActivity.this, "Ngày bắt đầu không được lớn hơn ngày kết thúc");
                    }
