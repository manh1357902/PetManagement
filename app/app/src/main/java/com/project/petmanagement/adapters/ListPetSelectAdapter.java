...
import com.project.petmanagement.activity.notification.vaccine.AddVaccinationNotificationActivity;
...
public class ListPetSelectAdapter extends RecyclerView.Adapter<ListPetSelectAdapter.PetViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PetViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(v -> {
            if (action != null) {
                Intent intent = new Intent(context, AddVaccinationNotificationActivity.class);
